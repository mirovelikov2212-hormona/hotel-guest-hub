...
test("explicit offer-detail CTA links outrank unrelated linked cards on an Offers landing", () => {
  const html = `
    <main>
      <h1>Offers</h1>
      <section>
        <a href="/en/heated-pool-privilege">
          A Heated Pool Privilege Special for Little Guests!
          <span>DETAILED REVIEW</span>
        </a>
        <a href="/en/two-children-stay-free">
      ...
      <section>
        <h2>Concepts</h2>
        <a href="/en/premium-for-kichies">Premium For Kichies</a>
  ...
  assert.deepEqual(
    offers.candidates.map((candidate) => candidate.links[0]).sort(),
    ["/en/heated-pool-privilege", "/en/two-children-stay-free"].sort(),
  );
});
