...
const COPY = {
  bg: {
    ...
    subtitle: "Системата събира доказателства сама. Няма операторски отметки и няма certification mutation на този етап.",
    genericStaff: "Generic Staff runtime",
    tenantIsolation: "Tenant isolation / CI",
    previewBuild: "Exact Vercel Preview",
    runtimeErrors: "Runtime error attestation",
    validated: "VALIDATED",
    pending: "PENDING",
    failed: "FAILED",
    ...
    blocked: "Sandbox certification остава блокирана, докато runtime error evidence не стане trusted и validated.",
    logReason: "Няма trusted Vercel log attestation. HTTP smoke не се приема като заместител.",
    runtimeProbeHash: "Runtime probe hash",
    releaseEvidenceHash: "Release evidence hash",
  },
  en: {
    title: "6. Trusted Sandbox evidence",
    subtitle: "The system derives evidence itself. There are no operator checkboxes and no certification mutation at this stage.",
    genericStaff: "Generic Staff runtime",
    tenantIsolation: "Tenant isolation / CI",
    previewBuild: "Exact Vercel Preview",
    runtimeErrors: "Runtime error attestation",
    ...
    releaseSha: "Candidate SHA",
    runtimeSha: "Runtime SHA",
    blocked: "Sandbox certification remains blocked until runtime error evidence is trusted and validated.",
    logReason: "No trusted Vercel log attestation is available. An HTTP smoke is not accepted as a substitute.",
    runtimeProbeHash: "Runtime probe hash",
    releaseEvidenceHash: "Release evidence hash",
  },
} as const;
