...
const COPY = {
  bg: {
    ...
    help: "Въведи публичния сайт на хотела. StayHub събира само публични страници, извлича доказуеми факти и създава review draft за следващата стъпка — Hub Design Studio.",
    ...
    next: "Следваща стъпка: Design Studio ще използва този структуриран профил за branding и Hub layout.",
  },
  en: {
    title: "AI hotel website scan",
    help: "Enter the hotel's public website. StayHub reads public pages only, extracts evidence-backed facts and creates a review draft for the next step — Hub Design Studio.",
    url: "Hotel website",
    placeholder: "https://hotel-example.com",
    scan: "Scan website",
    ...
    next: "Next: Design Studio will use this structured profile for branding and Hub layout.",
  },
} as const;
