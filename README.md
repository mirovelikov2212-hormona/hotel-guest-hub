...
| M13 — Checkout / Stay-End Read-Only Mode | NOT STARTED | pending M12 closure |
| M14 — Multi-Hotel Hardening | NOT STARTED | pending M13 closure |
| M15 — Observability & Operational Hardening | NOT STARTED | pending M14 closure |
| M16 — Final Multi-Hotel Certification | NOT STARTED | pending M15 closure |

## Operational documentation

- [M12 — Staff Sound & Notification Parity](docs/operations/m12-staff-notification-parity.md)
- [M11–M16 execution state](docs/runbooks/StayHub_M11_M16_execution_state.md)
