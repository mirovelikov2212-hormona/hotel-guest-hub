...
const COPY: Record<Lang, { flowTitle: string; flowText: string; views: ProductView[]; live: string; safe: string }> = {
  bg: {
    ...
    live: "Отвори live demo · PIN 2026",
    safe: "Demo tenant · без реални хотелски заявки",
    views: [
      { key: "guest", nav: "Guest Hub", eyebrow: "ГОСТЪТ", title: "Един QR. Целият престой.", text: "Гостът отваря брандиран хотелски hub директно в браузъра, потвърждава стаята и получава информация, услуги, AI concierge и заявки на своя език. Hub-ът може да се добави и на телефона като PWA / app shortcut.", points: ["Room confirmation", "Hotel info & venues", "AI concierge", "Direct service requests"], accent: "from-cyan-400/25 to-cyan-300/5" },
  ...
  en: {
    ...
    views: [
      { key: "guest", nav: "Guest Hub", eyebrow: "THE GUEST", title: "One QR. The whole stay.", text: "Guests open a branded hotel hub directly in the browser, confirm their room, and access hotel information, services, AI concierge and requests in their language. The hub can also be added to the phone as a PWA / app shortcut.", points: ["Room confirmation", "Hotel info & venues", "AI concierge", "Direct service requests"], accent: "from-cyan-400/25 to-cyan-300/5" },
  ...
  de: {
    ...
    views: [
      { key: "guest", nav: "Guest Hub", eyebrow: "DER GAST", title: "Ein QR. Der gesamte Aufenthalt.", text: "Gäste öffnen einen gebrandeten Hotel-Hub direkt im Browser, bestätigen ihr Zimmer und nutzen Informationen, Services, AI Concierge und Anfragen in ihrer Sprache. Der Hub kann zusätzlich als PWA / App-Shortcut zum Smartphone hinzugefügt werden.", points: ["Zimmerbestätigung", "Hotelinfo & Outlets", "AI Concierge", "Direkte Serviceanfragen"], accent: "from-cyan-400/25 to-cyan-300/5" },
