...
const COPY = {
  bg: {
    ...
    steps: [
      ...
      ["02", "Заявка", "Housekeeping или Maintenance"],
      ["03", "Staff Hub", "Виж и обработи същата заявка"],
      ["04", "Manager", "Виж operational evidence"],
    ],
  ...
  en: {
    ...
    steps: [
      ...
      ["02", "Request", "Housekeeping or Maintenance"],
      ["03", "Staff Hub", "See and process the same request"],
      ["04", "Manager", "See the operational evidence"],
    ],
  ...
  de: {
    ...
    steps: [
      ...
      ["02", "Anfrage", "Housekeeping oder Technik"],
      ["03", "Staff Hub", "Dieselbe Anfrage sehen und bearbeiten"],
      ["04", "Manager", "Operational Evidence sehen"],
    ],
