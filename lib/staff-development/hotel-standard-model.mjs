...
export const HOTEL_STAFF_STANDARD_SCHEMA_VERSION = "hotel-staff-standard-v1";
export const STAFF_TRAINING_PLAN_SCHEMA_VERSION = "staff-training-plan-v1";
...
export function normalizeHotelStaffStandard(input) {
  ...
  const normalized = {
    ...
    departmentCodes: normalizeCodes(
...
export function assertStaffTrainingAssignment(input) {
  ...
  if (!/^[0-9a-f-]{36}$/.test(staffUserId)) {
    throw new Error("STAFF_TRAINING_STAFF_USER_ID_INVALID");
  }
  if (!/^[0-9a-f-]{36}$/.test(hotelId)) {
