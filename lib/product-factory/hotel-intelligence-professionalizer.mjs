const CRITICAL_ATTRIBUTES = new Set([
  "check_in", "check_out", "hours", "external_access", "access", "dress_code", "age_policy",
  "pet_policy", "smoking_policy", "quiet_hours", "cancellation_policy", "payment_policy",
  "price", "price_context", "booking", "session_duration", "recommended_stay",
]);
...
export function professionalizeHotelIntelligencePackage(basePackage, options = {}) {
  ...
  return {
    ...basePackage,
    pipelineVersion: "professional-crawler-v3",
