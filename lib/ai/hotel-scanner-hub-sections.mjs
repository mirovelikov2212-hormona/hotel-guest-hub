...
export function hotelScannerHubSectionForFact(fact = {}) {
  ...
  // Guest services/amenities must stay separate from experiences. This override also
  // catches duplicate AI classifications such as a kids corner being called both an
  // amenity and an experience.
