import { canonicalizeLocaleTag } from "../i18n/locale-model.mjs";
...
export function validateGuestRequestCreatePayload(body) {
  ...
  const aiInteractionIdResult = optionalString(
    body,
    "aiInteractionId",
    LIMITS.aiInteractionId,
  );
  if (!aiInteractionIdResult.ok) return aiInteractionIdResult;
  ...
  return {
    ...
    value: {
      ...
      lateCheckoutRequestedTime,
      aiInteractionId: aiInteractionIdResult.value,
    },
  };
}
