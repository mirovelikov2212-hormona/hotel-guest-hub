...
function reconcileAccommodationInventory(siteMap, domain) {
  if (domain?.domain !== "accommodation" || domain?.expectationState !== "CONFLICT") return domain;
  if (!(domain?.issues || []).includes("canonical_entity_count_exceeds_explicit_count")) return domain;
  ...
  issues.push("dynamic_explicit_count_ignored_in_favor_of_named_superset");
