...
const DOMAIN_RULES = Object.freeze([
  ...
  },
  {
    ...
    path: /(?:^|\/)(?:experiences?|activities|things-to-do|discover|attractions?|aqua-?park|water-?park|sports?|ausfluge|erlebnisse|experiente|zazitky|преживявания|активности|забележителности|аквапарк|спорт)(?:\/|$)/iu,
    semantic: /(?:\bexperiences?\b|\bactivities\b|\battractions?\b|\baqua\s*park\b|\bwater\s*park\b|\bsports?\b|\berlebnisse\b|\bпреживявания\b|\bактивности\b|\bзабележителности\b|\bаквапарк\b|\bспорт\b)/iu,
  },
  {
