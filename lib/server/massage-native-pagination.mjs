...
/**
 * @typedef {{ from: number, to: number, pageIndex: number, pageSize: number }} MassageNativeAvailabilityRange
 */

/**
 * @template T
 * @param {(range: MassageNativeAvailabilityRange) => Promise<T[]>} fetchPage
