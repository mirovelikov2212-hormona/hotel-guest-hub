...
const HEADING_AUTHORITY_REQUIRED = new Set(["gastronomy", "spa", "services", "experiences", "events", "offers"]);
const GENERIC_HEADING = /^(?:home|about|overview|discover|discover more|learn more|read more|view more|book now|contact|contacts|our rooms(?:\s*&\s*suites)?|rooms(?:\s*&\s*suites)?|accommodations?|our restaurants|our dining venues|gastronomy|restaurants?|bars?|dining|food\s*&\s*drink|spa(?:\s*&\s*wellness)?|services?|our services|services we offer|the services we offer|experiences?|events?|offers?|partners?|included with every stay|quick navigation|plan your stay|начало|настаняване|нашите ресторанти|гастрономия|ресторанти|барове|хранене|спа(?:\s*&\s*уелнес)?|услуги|нашите услуги|услугите,?\s+които\s+предлагаме|преживявания|събития|оферти|партньори|открийте повече)$/iu;
...
function scoreBlock(block, domain) {
  ...
  // restaurants, services, experiences, events or offers merely because the
  // following text contains a domain keyword.
