...
const ENTERTAINMENT = /(?:\banimation\b|\bentertainment\b|\bshows?\b|\bpart(?:y|ies)\b|\bmini\s*disco\b|\bamphitheat(?:re|er)\b|\bamfitiyatro\b|\banimasyon\b|\beglence\b|\bgosteri\b|анимация|шоу|забавления|амфитеатър)/iu;
