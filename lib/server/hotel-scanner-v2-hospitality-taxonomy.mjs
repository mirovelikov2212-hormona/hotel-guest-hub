...
const OPERATIONAL_SERVICE = /(?:\bparking\b|\botopark\b|\btransfer\b|\bairport transfer\b|\bhavalimani transfer\b|\blaundry\b|\bcamasirhane\b|\breception\b|\bresepsiyon\b|\bwi-?fi\b|\bwireless\b|\bshop\b|\bstore\b|\bmagaza\b|\bexchange\b|\bcurrency exchange\b|\bdoviz\b|\bhairdresser\b|\bhair salon\b|\bbarbershop\b|\bkuafor\b|\bbeauty salo+n\b|\bguzellik salonu\b|\bmedical service\b|\bdoctor\b|\bdoktor\b|\binfo(?:rmation)?\s*(?:corner|desk|point)\b|\bconcierge\b|\bguest relations?\b|\bluggage storage\b|\bbaggage storage\b|\broom service\b|\bwake[- ]?up service\b|\bbabysitting\b|\bcar rental\b|\brent a car\b|\bbusiness cent(?:er|re)\b|\bbell desk\b|паркинг|трансфер|пералн|рецепция|магазин|обменно бюро|фризьор)/iu;
