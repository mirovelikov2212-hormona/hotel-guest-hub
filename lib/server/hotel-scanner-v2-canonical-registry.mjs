...
const GENERIC_BY_DOMAIN = Object.freeze({
  ...
  gastronomy: /^(?:gastronomy|gastronomie|gastronomija|гастрономия|гастрономија|our restaurants|our dining venues|restaurants & bars|restaurants and bars|нашите ресторанти|наши ресторани|ресторани и барови|restaurantele noastre|restaurante și baruri|restaurants und bars|unsere restaurants|restaurace a bary|ресторанты и бары|culinary world|the culinary world|culinary world inside|кулинарният свят|кулинарскиот свет однатре)$/iu,
  services: /^(?:services|our services|hotel services|amenities|facilities|услуги|нашите услуги|хотелски услуги|dienstleistungen|hoteldienstleistungen|servicii|servicii hoteliere|služby|hotelové služby|услуги отеля)$/iu,
