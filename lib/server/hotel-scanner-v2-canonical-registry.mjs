...
import { isAwardRecognitionHeadingV2, isFaqQuestionHeadingV2 } from "./hotel-scanner-v2-hospitality-taxonomy.mjs";
...
const GENERIC_BY_DOMAIN = Object.freeze({
  ...
  gastronomy: /^(?:gastronomy|gastronomie|gastronomija|гастрономия|гастрономија|restaurants?|bars?|dining|food\s*&\s*drink|restoranlar?|barlar?|yeme içme|yeme icme|our restaurants|our dining venues|restaurants & bars|restaurants and bars|нашите ресторанти|ресторанти|барове|хранене|нашите ресторани|наши ресторани|ресторани и барови|restaurantele noastre|restaurante și baruri|restaurants und bars|unsere restaurants|restaurace a bary|ресторанты и бары|culinary world|the culinary world|a culinary world(?: within)?|culinary world inside|кулинарният свят|кулинарен свят(?: отвътре)?|кулинарскиот свет однатре|eine kulinarische welt|o lume culinară|kulinářský svět|кулинарный мир)$/iu,
