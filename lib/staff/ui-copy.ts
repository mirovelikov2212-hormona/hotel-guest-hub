...
const copy = {
  bg: {
    ...
    topProblemTypesText: "Тези услуги и проблеми се повтарят най-често в хотела.",
  ...
  en: {
    ...
    topProblemTypesText: "These services and issues appear most often in the hotel.",
  ...
  de: {
    ...
    topProblemTypesText: "Diese Services und Probleme treten im Hotel am häufigsten auf.",
