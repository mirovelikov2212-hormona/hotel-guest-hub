...
const copy = {
  bg: {
    ...
    billingWaived: "Без начисляване",
    billingCancelled: "Отказана услуга",
    reports: "Отчети",
    reportsIntro:
  ...
  en: {
    ...
    billingWaived: "No charge",
    billingCancelled: "Cancelled service",
    reports: "Reports",
    reportsIntro:
  ...
  de: {
    ...
    billingWaived: "Ohne Buchung",
    billingCancelled: "Stornierte Leistung",
    reports: "Berichte",
    reportsIntro:
